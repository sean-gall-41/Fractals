...
private:
    ...
    /*
     * Initiates a draw Menger Sponge operation on the window.
     */
    void doMengerSponge();
    ...
    //If want to make more fractals, must add a button(pointer) here
    // west buttons to draw fractals
    GButton* sierpinskiButton;
    GButton* treeButton;
    GButton* mandelbrotButton;
    GButton* mengerSpongeButton;
    GButton* diffButton;
    GButton* clearButton;
